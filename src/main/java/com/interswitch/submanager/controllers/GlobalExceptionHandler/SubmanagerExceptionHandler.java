package com.interswitch.submanager.controllers.GlobalExceptionHandler;
...
public class SubmanagerExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleSubmanagerException(final Exception ex, final WebRequest request) {
        logger.info(ex.getClass().getName());
        logger.error("error", ex);
        //
